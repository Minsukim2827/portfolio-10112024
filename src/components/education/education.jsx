...
export default function Education() {
  return (
    (<section
      className="py-12 px-4 md:px-8 lg:px-12 bg-black dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto">
        <h2
          className="text-3xl font-bold text-center mb-8 text-white dark:text-gray-100">Education</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card
            className="bg-black dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardHeader>
              <CardTitle
